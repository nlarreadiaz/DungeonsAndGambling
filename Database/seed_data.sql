...
INSERT OR IGNORE INTO items (id, name, description, item_type, rarity, price, icon, max_stack, usable_in_battle, effect_data) VALUES
    ...
    (4, 'Armadura de Cuero', 'Proteccion ligera para aventureros.', 'armor', 'common', 90, 'res://assets/items/generated_pixel_equipment/armor_01.png', 1, 0, '{"defense_bonus":6}'),
    ...
    (7, 'Armadura de Malla', 'Anillas reforzadas para resistir golpes directos.', 'armor', 'uncommon', 145, 'res://assets/items/generated_pixel_equipment/armor_06.png', 1, 0, '{"defense_bonus":10}'),
    (8, 'Coraza de Guardia', 'Placas firmes con buen equilibrio de peso.', 'armor', 'rare', 220, 'res://assets/items/generated_pixel_equipment/armor_14.png', 1, 0, '{"defense_bonus":15}');
